...
var url = "https://brainstormforce.com/";
...
fetch('https://api.themesinfo.com/v3/details.json', {
            ...
            <div class="panel-heading" style="background-color:#2E2D2E;padding: 10px 25px;
                border-bottom: 1px solid transparent;"><h3 class="panel-title" style="font-size:13px;color:white;text-shadow:rgba(0, 0, 0, 0.219608) 0 1px 0;margin:0px;">Detected WordPress Theme${data.theme_count > 1 ? 's' : ''} (${data.theme_count}x)<a href="" target="_blank" style="text-align:right;font-size:12px;float:right;color:#c6c6c6;font-weight: normal"> <</a></h3>
            ...
            <div class="starter-template" style="border-radius: 6px;margin:0 10px;padding:0px 10px 0 10px;">
                ...
                <div class="table-responsive" style="font-size: 13px;float:left;width:360px">
                    <form id="form_theme" method="post" action='' target="_blank">
